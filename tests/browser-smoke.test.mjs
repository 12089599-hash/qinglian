...
assert.match(html, /<body data-active-tab="overview" data-active-group="practice" data-access-locked="true">/);
assert.match(html, /data-access-gate/);
assert.match(html, /data-access-input type="password"/);
assert.match(source, /function createAccessGate/);
