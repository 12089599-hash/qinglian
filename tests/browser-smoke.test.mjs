...
assert.match(source, /function createActiveDepthBattleReport/);
assert.match(source, /function ensureActiveDepthPlayback/);
assert.match(source, /holdUntilMissionEnd/);
