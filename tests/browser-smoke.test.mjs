...
assert.match(styles, /body\[data-active-tab="overview"\]\s+\.hero\s*\{[^}]*min-height:\s*232px/s);
assert.match(styles, /body\[data-active-tab="overview"\]\s+\.hero canvas\s*\{[^}]*height:\s*232px/s);
